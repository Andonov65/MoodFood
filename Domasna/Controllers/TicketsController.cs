...
namespace Domasna.Controllers
{
    public class TicketsController : Controller
    {
        ...
        {
            var userId = User.FindFirstValue(ClaimTypes.NameIdentifier); //ova ni go dava ID na najaveniot korisnik
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Create([Bind("Id,TicketName,TicketImage,TicketDescription,TicketPrice,Rating")] Ticket ticket)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Edit(Guid id, [Bind("Id,TicketName,TicketImage,TicketDescription,TicketPrice,Rating")] Ticket ticket)
        {
            if (id != ticket.Id)
            {
                return NotFound();

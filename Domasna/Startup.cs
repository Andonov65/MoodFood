...
using Domasna.Repository.Implementation;
using Domasna.Repository.Interface;
using Domasna.Services.Implementation;
...
namespace Domasna
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDefaultIdentity<DomasnaApplicationUser>(options => options.SignIn.RequireConfirmedAccount = true)
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                endpoints.MapControllerRoute(
                    name: "default",
                    pattern: "{controller=TicketProducts}/{action=Index}/{id?}");
